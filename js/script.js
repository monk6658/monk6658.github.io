        ...
        content.find('img:not([data-ignore])').each(function () {
            ...
            if ($(window).width() > 426) {
                $(this).on("click", function (e) {
                    ...
                    } else if($(".img_hidden").height() === 0 || $(".img_hidden").width() === 0){
                        img_height = ($(".img_hidden").height() === 0 ? document.body.clientHeight : $(".img_hidden").height())  + "px";
                        img_width = ($(".img_hidden").width() === 0 ? document.body.clientWidth : $(".img_hidden").width()) + "px";
                        img_top = 0 + "px";
                        img_left = 0 + "px";
                    }else{
